...
export default {
  ...
  locales: {
    "/": {
      ...
      title: "Muggle blog",
      description:
        "web前端技术博客,专注前端学习与总结。包括但不限于分享JavaScript,js,ES6,TypeScript,vue,ts,css3,css,html5,html,Node,git等技术文章。"
    }
  },
  head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "前端博客,个人技术博客,前端,前端开发,前端框架,web前端,前端面试题,技术文档,学习,面试,JavaScript,js,ES6,TypeScript,ts,vue,css3,html5,node.js,Node,git,github,markdown"
      }
    ]
